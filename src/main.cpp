...
int main(int argc, char* argv[])
{
    ...
    program.add_argument("from_software")
        .help("the software which generated the 'input_file'"); // TODO include list of choices
    program.add_argument("input_file").help("the file from the software to convert");
    program.add_argument("to_software")
        .help("convert the given library in the 'input_file' for this software");
    ...
    IDjingSoftware* from_software_adapter = DjingSoftwareAdapterFactory::create(from_software);
    IDjingSoftware* to_software_adapter = DjingSoftwareAdapterFactory::create(to_software);
    // End Adapters initialization part

    // Convertion part
    FileIO file_io;
    LibraryConverter converter
        = LibraryConverter(&file_io, from_software_adapter, to_software_adapter);
